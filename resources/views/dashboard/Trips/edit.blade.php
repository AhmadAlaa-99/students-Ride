                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>ادارة الرحلات</h3>
                            <p class="text-subtitle text-muted">تعديل رحلة</p>
                        </div>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                    <form class="form form-horizontal" action="{{route('trips.update',$trip->id)}}" method="post" enctype="multipart/form-data"
                        autocomplete="off"> 
